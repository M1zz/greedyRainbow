...
class LogicTest(BaseTestCase):
    ...
    def test_스케쥴_삽입가능(self):
        # Given
        user_data = ["hyunho", 0, ["2019-04-16 09:30:00", "2019-04-16 10:30:00"],
    ...
    def test_스케쥴_삽입_불가능(self):
        # Given
        user_data = ['hyunho', 0, ['2019-04-16 10:00:00', '2019-04-16 12:00:00'],
                     ['2019-04-16 13:00:00', '2019-04-16 15:00:00']]
    ...
    def test_스케쥴_삽입_처음(self):
        ...
        username = "hyunho"
        insert_data = ["2019-04-16 11:00:00", "2019-04-16 12:00:00"]
        expected = [["hyunho", 0, ["2019-04-16 11:00:00", "2019-04-16 12:00:00"]]]
        c = controller.Controller()
    ...
    def test_스케쥴_삽입_1번째_줄(self):
        ...
        user_data = [["hyunho", 0, ["2019-04-16 09:30:00", "2019-04-16 10:30:00"]]]
        insert_data = ["2019-04-16 11:00:00", "2019-04-16 12:00:00"]
        expected = [["hyunho", 0, ["2019-04-16 09:30:00", "2019-04-16 10:30:00"],
                     ["2019-04-16 11:00:00", "2019-04-16 12:00:00"]]]
        username = "hyunho"
        temp = [['hyunho', 0, ['2019-04-16 10:00:00', '2019-04-16 12:00:00'],
                 ['2019-04-16 13:00:00', '2019-04-16 15:00:00']]]
        c = controller.Controller()
    ...
    def test_스케쥴_삽입_2번째_줄(self):
        ...
        expected = [["hyunho", 0, ["2019-04-16 10:00:00", "2019-04-16 12:00:00"],
                     ["2019-04-16 13:00:00", "2019-04-16 15:00:00"]],
    ...
    def test_스케쥴_삽입_긴_줄(self):
        ...
        expected = [["hyunho", 0, ["2019-04-16 01:00:00", "2019-04-16 23:00:00"]],
                    ["hyunho", 1, ["2019-04-16 10:00:00", "2019-04-16 12:00:00"],
                     ["2019-04-16 13:00:00", "2019-04-16 15:00:00"]],
    ...
    def test_스케쥴_수정_2째줄로(self):  # Given
        ...
        expected = [["hyunho", 0, ["2019-04-16 09:30:00", "2019-04-16 15:30:00"]],
                    ["hyunho", 1, ["2019-04-16 10:00:00", "2019-04-16 12:00:00"],
                     ["2019-04-16 13:00:00", "2019-04-16 15:00:00"]]]
        c = controller.Controller()
